    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', regex='^[\\w.@+-]+')], verbose_name='Имя пользователя')),
